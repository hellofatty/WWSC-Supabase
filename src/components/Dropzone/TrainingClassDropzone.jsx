...
function TrainingClassDropzone({ uploadFiles, setUploadFiles, id, fileURL, setFileURL, uid, referee }) {
    ...
    const handleUpload = async () => {
        (await uploadFiles) &&
            uploadFiles.forEach((file) => {
                ...
                const uploadPath = `records/class/${referee.refereeId}-${uid}/${id}/${file.name}_${currenDate}`;
                setLoading(true);
...
export default TrainingClassDropzone;
