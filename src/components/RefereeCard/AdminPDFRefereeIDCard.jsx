...
import { BackCardContentRefereeClean, FrontCardContentRefereeClean } from "./Contents/RefereeContents";

function AdminPDFRefereeIDCard({ referee }) {
    ...
    return (
        <>
            ...
            >
                ...
                >
                    {t("admin.referee-list.back-to-referee-profile")} <KeyboardDoubleArrowRightIcon />
                </span>
            </Link></div>
...
export default AdminPDFRefereeIDCard;
