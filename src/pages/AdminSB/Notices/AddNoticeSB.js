...
export default function AddNotice({ toggle }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.success(t("admin.notice-form.add-success-message"));
            reset();
            toggle();
        } catch (error) {
            console.error("Error adding notice:", error);
            toast.error(t("admin.notice-form.add-error-message"));
        } finally {
            setIsPending(false);
        }
    };
                        ...
                        <div>
                            <Accordion defaultExpanded>
                                <AccordionSummary
                                    ...
                                    id="panel1-header"
                                >
                                    <h5 style={{ color: "tomato" }}>English</h5>
                                </AccordionSummary>
                                <AccordionDetails>
                                    <Row>
                                        <Col md={6}>
