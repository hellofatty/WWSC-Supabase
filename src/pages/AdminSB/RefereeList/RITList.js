...
export default function RITList() {
    // All referees

    const { t } = useTranslation("global");

    const { documents: RITList, error } = useCollection("users", ["grade", "==", "0"]);
                            ...
                            <Table sx={{ minWidth: 350 }} size="small" aria-label="simple table">
                                <TableHead>
                                    <TableRow style={{ backgroundColor: "grey" }}>
                                        <TableCell style={{ color: "white", whiteSpace: "nowrap", width: "30px" }}>
                                        ...
                                        currentRows
                                            ...
                                            .map((user) => (
                                                ...
                                                >
                                                    ...
                                                    <TableCell align="center">{user.otherName}</TableCell>
