...
export default function RefereeDashboard({ referee, uid }) {
            ...
            >
                <div className="item-wrapper" style={{ marginTop: "5px" }}>
                    <div className="referee-list-avater">
                        <div>
                            <img className="profile-card-avatar-circle" src={referee.photoURL} alt="referee avatar" />
                        </div>
                    </div>
                ...
                <div className="item-more-info" style={{ position: "absolute", bottom: "6px", right: "12px" }}>
                    <Link to="/referee-zone/referee-home/referee-profile">
                        <Tooltip
                            title={
                                referee.grade !== "0"
    ...
    const refereeGamesRecordsProgress = (
        <div>
            ...
            <Item style={{ background: "purple", color: "white", position: "relative" }}>
                ...
                <div className="item-more-info" style={{ position: "absolute", bottom: "6px", right: "12px" }}>
                    <Link to="/referee-zone/referee-home/referee-game-records">
                        <Tooltip
