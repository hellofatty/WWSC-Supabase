...
export default function EditGameRecordSB({ uid, record, toggle }) {
    ...
    const [date, setDate] = useState(moment.utc(record.date).format("YYYY-MM-DD"));
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            // navigate(location.pathname); // Redirect to the same page to refresh the data
            toggle();
        } catch (err) {
                ...
                <Form onSubmit={handleUpdate}>
                    <div className="modal-form-input-container">
                        ...
                        <FormGroup>
                            ...
                            {lang === "en" && (
                                <Select
                                    placeholder="Select org. holding the game..."
                                    options={orgs}
