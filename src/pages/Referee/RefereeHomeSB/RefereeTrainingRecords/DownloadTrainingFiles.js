...
export default function DownloadTrainingFiles({ record, toggle, uid, referee }) {
    ...
    useEffect(() => {
        ...
        const listRef = storageRef.child(`records/training/${referee.refereeId}-${uid}/${record.id}/`);
        ...
        listRef
            ...
            // .then((res) => {
            //     const fileURLs = res.items.map((itemRef) => itemRef.getDownloadURL());
