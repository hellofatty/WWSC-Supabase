...
export default function TermsEng() {
    return (
        <>
            <div className="page-primary-title">Website Terms and Conditions of Use</div>
          <AccordionGroup size="sm" disableDivider >
                <Accordion>
                    <AccordionSummary>
                        <div className="page-subtitle2">I. &nbsp;INTRODUCTION</div>
                    </AccordionSummary>
                    <AccordionDetails>
                ...
                <Accordion>
                    <AccordionSummary>
                        <div className="page-subtitle2">II. &nbsp;OWNERSHIP OF THE SITE AND ITS CONTENTS</div>
                    </AccordionSummary>
                    <AccordionDetails>
                        <p style={{ textIndent: "0" }}>
                ...
                <Accordion>
                    <AccordionSummary>
                        <div className="page-subtitle2">III. &nbsp;TRADEMARKS/COPYRIGHTS</div>
                    </AccordionSummary>
                    <AccordionDetails>
                        <p style={{ textIndent: "0" }}>
                ...
                <Accordion>
                    <AccordionSummary>
                        <div className="page-subtitle2">IV. &nbsp;RESPONSIBLE USE AND CONDUCT</div>
                    </AccordionSummary>
                    <AccordionDetails>
                        <p style={{ textIndent: "0" }}>
                        ...
                        <p style={{ textIndent: "0" }}>Wherein, you understand that:</p>
                        <div className="w3-section">
                            <ol type="a" style={{ color: "teal", fontSize: "0.9rem", lineHeight: "1.8" }}>
                                ...
                                <li>
                                    ...
                                    the servers and/or networks at which our Resources are located or to which our
                                    Resources are connected, is strictly prohibited.
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    by you, as illustrated above, and you may incur criminal or civil liability.
                                </li>
                                <li>
                                    ...
                                    communication tools on our website, provided that it does not violate or infringe on
                                    any third party intellectual property rights, becomes the property of the WWSC, and
                                    as such, gives us a perpetual, irrevocable, worldwide, royalty-free, exclusive
                                ...
                                <li>
                                    ...
                                    any violation of this User Agreement or the failure to fulfill any obligations
                                    relating to your account incurred by you or any other person using your account. We
                                    reserve the right to take over the exclusive defense of any claim for which we are
                ...
                <Accordion>
                    <AccordionSummary>
                        <div className="page-subtitle2">V. &nbsp;PRIVACY POLICY</div>
                    </AccordionSummary>
                    <AccordionDetails>
                        <p style={{ textIndent: "0" }}>
                ...
                <Accordion>
                    <AccordionSummary>
                        <div className="page-subtitle2">VI. &nbsp;LINKS</div>
                    </AccordionSummary>
                    <AccordionDetails>
                        <p style={{ textIndent: "0" }}>
                ...
                <Accordion>
                    <AccordionSummary>
                        <div className="page-subtitle2">VII. &nbsp;DISCLAIMER NOTICE</div>
                    </AccordionSummary>
                    <AccordionDetails>
                        <div className="page-subtitle2">(1) LIMITATION OF WARRANTIES</div>
                        ...
                        <div className="detail-section" style={{ marginBottom: "0", marginTop: "0" }}>
                            <ol type="i">
                        ...
                        <div className="detail-section" style={{ marginBottom: "0", marginTop: "0" }}>
                            <p style={{textIndent:"0", marginTop:"10px", marginBottom:"0"}}>Furthermore, you understand and agree that:</p>
                            <ol type="i">
                                <li>
                                    ...
                                    the download of such content, and
                                </li>
                                <li>
                                    no information or advice, whether expressed, implied, oral or written, obtained by
                                    you from the WWSC or through any Resources we provide shall create any warranty,
                                    guarantee, or conditions of any kind, except for those expressly outlined in this
                                    User Agreement.
                                </li>
                            </ol>
                        </div>
                        <div className="page-subtitle2">(2) LIMITATION OF LIABILITY</div>
                        <p style={{textIndent:"0", marginTop:"10px"}}>
                        ...
                        <div className="page-subtitle2">(3) LANGUAGE TRANSLATION DISCLAIMER</div>
                        <p style={{textIndent:"0", marginTop:"10px"}}>
                        ...
                        <div className="page-subtitle">(4) FORCE MAJEURE</div>
                        <p style={{textIndent:"0", marginTop:"10px"}}>
                        ...
                        <div className="page-subtitle2">(5) WAIVER</div>
                        <p style={{textIndent:"0", marginTop:"10px"}}>
                ...
                <Accordion>
                    <AccordionSummary>
                        <div className="page-subtitle2">VIII. &nbsp;TERMINATION OF USE</div>
                    </AccordionSummary>
                    <AccordionDetails>
                        <p style={{textIndent:"0"}}>
                ...
                <Accordion>
                    <AccordionSummary>
                        <div className="page-subtitle2">IX. &nbsp;GOVERNING LAW</div>
                    </AccordionSummary>
                    <AccordionDetails>
                        <p style={{textIndent:"0"}}>
                ...
                <Accordion>
                    <AccordionSummary>
                        <div className="page-subtitle2">X. &nbsp;NOTIFICATION OF CHANGES</div>
                    </AccordionSummary>
                    <AccordionDetails>
                        <p style={{textIndent:"0"}}>
                ...
                <Accordion>
                    <AccordionSummary>
                        <div className="page-subtitle2">XI. &nbsp;CONTACT INFORMATION</div>
                    </AccordionSummary>
                    <AccordionDetails>
                        <p style={{textIndent:"0"}}>
                        ...
                        <div className="w3-section">
                            ...
                            <p className="w3-center w3-section">
                                ©2012-2025 World Wiser Sport Committee. All Rights Reserved.
                            </p>
                        </div>
                    </AccordionDetails>
                </Accordion>
