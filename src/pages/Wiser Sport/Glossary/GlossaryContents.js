...
export const orderContent = (
    <>
        <ResParagraphNoIndent>
            The following common terminologies of the Wiser sport are listed based on the order in which they appear in
            the <Link to="/wiser-sport/the-rules-of-wiser-sport/">rules handbook:</Link>
        </ResParagraphNoIndent>
        <table className="w3-table w3-bordered">
            <tbody>
                <tr className="w3-light-grey g-table-row">
                    <th>Terminology</th>
                    <th>Description</th>
                </tr>
                <tr>
        ...
        <div style={{ fontSize: "0.75rem", color: "teal", marginTop: "12px" }}>
            <span style={{color:"tomato"}}>*</span> This rule is only appliable for <strong>general promotion and practice games</strong> and not applicable
            for <strong>official Wiser ball competitions</strong>
        </div>
    </>
);

export const alphabetContent = (
    <>
        <ResParagraphNoIndent>
        ...
        <div style={{ fontSize: "0.75rem", color: "teal", marginTop: "12px" }}>
        <span style={{color:"tomato"}}>*</span> This rule is only appliable for <strong>general promotion and practice games</strong> but not applicable
            for <strong>official Wiser ball competitions</strong>
        </div>
    </>
);
...
export const orderContent_zh_TW = (
    <>
        <ResParagraphNoIndent>
        ...
        <div style={{ fontSize: "0.75rem", color: "teal", marginTop: "12px" }}>
        <span style={{color:"tomato"}}>*</span> 此規則僅適用於<strong>一般推廣和練習賽</strong>使用，但並不適用於<strong>正式Wiser球競賽</strong>使用。
        </div>
    </>
);

export const alphabetContent_zh_TW = (
    <>
        <ResParagraphNoIndent>
...
export const orderContent_zh_CN = (
    <>
        <div style={{ fontSize: "0.7rem", color: "teal", marginTop: "12px" }}>
        ...
        <div style={{ fontSize: "0.7rem", color: "teal", marginTop: "12px" }}>
        <span style={{color:"tomato"}}>*</span> 此规则仅适用於<strong>一般推广和练习赛</strong>使用，但并不适用於<strong>正式Wiser球竞赛</strong>使用。
        </div>
    </>
);
export const alphabetContent_zh_CN = (
    <>
        <ResParagraphNoIndent>
        ...
        <table className="w3-table w3-bordered">
            <tbody>
                ...
                <tr>
                    <td>出局</td>
                    <td>
                        (1) 当「二关」的球之後再被球击中第三次，该球的球员就被判为「出局」; (2)
                        球误击中同队队友的球，该球也被判为「出局」。(见 “误击”)
                    </td>
                </tr>
                <tr>
